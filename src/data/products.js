...
export const PRODUCTS = [
  // ——— Quirky ———
  P(1, 'Mystery Gift Box — Chhota Surprise', 149, 'quirky', '🎁', 'Kya niklega? Wahi toh maza hai. Guaranteed smile inside.', 4.6, '1513201099705-a9746e1e201f', true, 299, 1),
  ...
  P(7, 'Mini Designer Chair — Desk Décor', 199, 'quirky', '🪑', 'Famous chair, chhota size. Instant designer feels on your desk.', 4.4, '1517705008128-361805f42e86', true, 399, 2),
  ...
  P(14, 'Retro Wired Headphones', 349, 'phone', '🎧', 'Purana school, naya swag. Bass included.', 4.4, '1583394838336-acd977736f90', true, 599, 6),
  ...
  P(23, 'Glitter Nail Polish Minis (4)', 199, 'beauty', '💅', 'Chhoti bottles, badi sparkle. Commitment-free colours.', 4.3, '1522337660859-02fbefca4702', false, null, 4),
  ...
  P(26, 'Vintage-Style Mini Perfume', 249, 'beauty', '🌸', 'Pocket mein old-money vibes. Ek dab kaafi hai.', 4.8, '1541643600914-78b084683601', true, 449, 3),
  P(27, 'Glow Serum Mini (30ml)', 299, 'beauty', '🧴', 'Ek pump mein spa wali feeling.', 4.5, '1556228578-8c89e6adf883', false, null, 5),
  P(28, 'Shimmer Palette Mini (12 shades)', 149, 'beauty', '💫', 'Disco ball energy, eyes edition.', 4.2, '1512496015851-a90fb38ba796', false, null, 2),
  ...
  P(34, 'SALE Tag Sticker Pack (20 pc)', 119, 'quirky', '🏷️', 'Sab pe SALE lagao, bhaav khud set karo.', 4.4, '1607083206968-13611e3d76db', false, null, 5),
  ...
  P(37, 'Festive Gift Wrap Kit', 149, 'home', '🎀', 'Gift dena ek art hai. Is kit se full pro lagoge.', 4.2, '1549465220-1a8b9238cd48', false, null, 6),
  ...
  // ——— Accessories ———
  P(41, 'Statement Earrings — Royal Blue', 149, 'accessories', '💎', 'Ek pair, poora outfit carry.', 4.5, '1535632066927-ab7c9ab60908', true, 299, 1),
  P(42, 'Mini Sling Bag — Tan Wicker', 449, 'accessories', '👝', 'Phone, lipstick, vibes — bas itna hi chahiye.', 4.4, '1590874103328-eac38a683ce7', false, null, 4),
  ...
  P(44, 'Retro Wayfarer Shades', 299, 'accessories', '🕶️', 'Dekho sab kuch cool se. Full filmy entry.', 4.3, '1572635196237-14b3f281503f', false, null, 6),
  P(45, 'Pearl Charm Necklace', 199, 'accessories', '📿', 'Thoda sa old-money, full elegance.', 4.6, '1515562141207-7a88fb7ce338', false, null, 2),
]
